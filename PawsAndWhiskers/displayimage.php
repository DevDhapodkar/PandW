        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="displayimage.php">Servics</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="feedback.php">Contact us</a>
                    </li>
                    <div class="navbar-button">
                        <button type="button" onclick="location.href='uploadimage.php'">Upload</button>
                    </div>
                </ul>
            </div>
        </div>
...
$result = mysqli_query($db, "SELECT* from items ORDER by id DESC");
...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo '<a href="uploads/' . $row['image'] . '" download><button class="btn download-btn">Download</button></a>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
}
